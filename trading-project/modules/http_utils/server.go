...
import (
	...
	apiInitializer "trading-project/modules/http_utils/http_server_routes"
...
func StartHosting() {
	...
	resgiterErr := apiInitializer.RegisterAPI(db)
...
func initDB() (*sql.DB, error) {
	...
	dsn := "myuser:mypassword@tcp(db:3306)/db-trading"
